			...
			<main className="flex-1 px-6 py-16 md:py-24">
				<div className="mx-auto max-w-4xl rounded-2xl bg-white p-8 shadow-xl md:p-12">
					...
					<div className="space-y-8 text-gray-700">
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">1. Information We Collect</h2>
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">2. How We Use Your Information</h2>
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">3. Payment Processing</h2>
							<p>
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">4. Data Sharing</h2>
							<p className="mb-2">
							...
							<p className="mt-2 text-sm text-gray-500">only to operate and improve our platform.</p>
						</section>

						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">5. Data Security</h2>
							<p>
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">7. User Rights</h2>
							<p>
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">8. Third-Party Links</h2>
							<p>
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">9. Changes to This Policy</h2>
							<p>
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">10. Contact Us</h2>
							<p className="mb-2">
								If you have any questions or concerns regarding this Privacy Policy, you can contact us at:
							</p>
							<p className="font-semibold">
								Email: <a href="mailto:support@unievents.in" className="text-[#030370] hover:underline">support@unievents.in</a>
							</p>
						</section>

						<div className="mt-8 rounded-lg bg-gray-50 p-4 text-center font-medium text-gray-800 border border-gray-100">
