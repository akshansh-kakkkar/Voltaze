				...
				<div className="mx-auto max-w-4xl rounded-xl bg-white p-5 shadow-lg sm:rounded-2xl sm:p-8 md:p-12 md:shadow-xl">
					...
					<div className="space-y-6 text-gray-700 sm:space-y-8">
						<p className="text-sm leading-relaxed sm:text-base md:text-lg">
							Welcome to UNIEVENTS. By accessing or using our platform, you
						...
						<section>
							...
							<p className="text-sm sm:text-base md:text-lg">
								Event organizers are solely responsible for the accuracy of
								event details, including date, time, venue, and pricing.
								UNIEVENTS is not responsible for any changes, cancellations, or
								inaccuracies in event information.
							</p>
						</section>
						...
						<section>
							...
							<p className="text-sm sm:text-base md:text-lg">
								...
								organizers. UNIEVENTS is not responsible for incorrect
