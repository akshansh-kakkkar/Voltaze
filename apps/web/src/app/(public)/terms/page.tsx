				...
				<div className="mx-auto max-w-4xl rounded-2xl bg-white p-8 shadow-xl md:p-12">
					...
					<div className="space-y-8 text-gray-700">
						<p className="text-lg leading-relaxed">
							Welcome to UNIEVENTS. By accessing or using our platform, you agree to comply with and be bound by the following Terms and Conditions.
						</p>

						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">1. Platform Usage</h2>
							<p>
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">2. User Accounts</h2>
							<p>
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">3. Event Listings</h2>
							<p>
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">4. Ticketing and Payments</h2>
							<p>
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">5. Cancellation and Refunds</h2>
							<p>
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">6. Certificates and Digital Services</h2>
							<p>
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">7. Prohibited Activities</h2>
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">8. Intellectual Property</h2>
							<p>
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">9. Limitation of Liability</h2>
							<p>
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">10. Termination</h2>
							<p>
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">11. Changes to Terms</h2>
							<p>
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">12. Governing Law</h2>
							<p>
						...
						<section>
							...
							<p className="font-semibold">
								Email: <a href="mailto:contactt@unievent.in" className="text-[#030370] hover:underline">contactt@unievent.in</a>
							</p>
						</section>
					</div>
				</div>
