			...
			<main className="flex-1 px-6 py-16 md:py-24">
				<div className="mx-auto max-w-4xl rounded-2xl bg-white p-8 shadow-xl md:p-12">
					...
					<div className="space-y-8 text-gray-700">
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">1. Event-Based Refunds</h2>
							<p>
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">2. Organizer Responsibility</h2>
							<p>
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">3. Platform Role</h2>
							<p>
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">4. Non-Refundable Cases</h2>
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">5. Event Cancellation</h2>
							<p>
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">6. Processing Time</h2>
							<p>
						...
						<section>
							<h2 className="mb-3 font-bold text-2xl text-black">7. Service Fees</h2>
							<p>
